...
class Model:
    def __init__(
        ...
        abundance_factor=20,
        oasis_density=0.24,
        initialise_crews=True,
        food_consumption_speed=2,
        crew_energy_expenditure=1,
    ):
        """
        ...
        self.oasis_density = oasis_density
    ...
    def add_chimp_crew(self, pos=None, type=None):
        ...
        new_crew = Chimp_crew(
            ...
            energy,
            type,
            consumption_rate=self.crew_consumption_rate,
            expenditure=self.crew_energy_expenditure,
        )
